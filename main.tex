...
\todo{Look at the comparison... they have significant differences... Questions: 
\begin{itemize}
    \item Are the profiles really profiles or sometimes ``histograms"?
    \item The division by the intensity for getting DoC adds a lot of noise when the intensity is small. Can we compare CSD((x1+x2)/2,(x1-x2)/2)? 
...
\begin{figure}
    ...
    \includegraphics[width=0.35\textwidth]{figures/CSD_WOFRY1D_vs_I_source_h.pdf}
    \includegraphics[width=0.35\textwidth]{figures/CSD_WOFRY1D_vs_I_source_v.pdf}
...
\begin{figure}
    ...
    \includegraphics[width=0.35\textwidth]{figures/CSD_WOFRY1D_vs_I_36m_h.pdf}
    \includegraphics[width=0.35\textwidth]{figures/CSD_WOFRY1D_vs_I_36m_v.pdf}
