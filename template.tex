...
\vspace{0.5cm}
We introduce the different methods used for dealing with partially coherence beams emitted by undulators in low-emittance storage rings:
hybrid ray tracing in ShadowOUI, Monte Carlo multielectron simulations as implemented in SRW, and CMD, as implemented in COMSYL (2D) and WOFRY (1D). 
...
\subsection{Multielectron Monte Carlo (SRW)}
...
2020 Research and Innovation programme under Grant Agreement No 823852 (PaNOSC).
